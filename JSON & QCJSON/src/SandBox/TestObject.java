...
public class TestObject implements Serializable {
    ...
    public TestObject(String theString, int theInt, Date theDate) {
        this.theString = theString;
        this.theInt = theInt;
        this.theDate = theDate;
    }

    public TestObject(HashMap aMap){
        this.theString = (String)aMap.get("theString");
        //dates are stored as timestamp strings.
        String stampString = (String)aMap.get("theDate");
        this.theDate = new Date(Timestamp.valueOf(stampString).getTime());
        //numbers are stored as longs or doubles.
        Long asLong = (Long)aMap.get("theInt");
